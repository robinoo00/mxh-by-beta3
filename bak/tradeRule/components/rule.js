                    ...
                    <div styleName="wrap">
                        <div styleName="pt20">
                            <table>
                                ...
                                <tr>
                                    <td>隔夜设置</td>
                                    <td style={{backgroundColor:'#ffff00',color:'#ff3e00'}}>本金隔夜和隔下午（5万可留仓一手），隔夜仓和隔下午仓最后十分钟禁止交易。除非特别申请并通过，一般默认不隔夜（收盘前十分钟强平）。</td>
                                </tr>
                                <tr>
                                    <td>强制平仓比例</td>
                                ...
                                <tr>
                                    <td rowSpan={3}>出入金时间</td>
                                    <td>
                                        入金时间规则<br/>
                                        8:30—12:30  入金，资金在13:00开盘前到帐。<br/>
                                        12:30—20:30 入金，资金在21:00开盘前到帐。<br/>
                                        20:30—次日8:30  入金，资金在次日9:00开盘前到帐<br/>
                                        <section style={{color:'#ff3e00'}}>
                                            交易时间段入金，选择微信和支付宝方式在两个小时内到帐(加急通道）。
                                        </section>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        出金时间规则（每天限出一次）<br/>
                                        当日17:00前出金，资金在T1日（T为工作日）17:00前到帐。<br/>
                                        当日17:00后出金，资金在T2日（T为工作日）17:00前到帐。<br/>
                                    </td>
                                </tr>
                                </tbody></table>
                        </div>
